...
module.exports = {
                ...
                <table style="width: 500px; margin-left: auto; margin-right: auto;">
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center; padding-top: 45px; line-height: 18px; letter-spacing: 1px;">
                            ...
                            <a href="https://google.com" style="font-weight: 400; font-size: 12px; font-style: normal; text-decoration: none;">
                                https://google.com
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="text-align: center; padding-top: 70px; line-height: 30px; letter-spacing: 0.15px;">
                            ...
                            <a href="mailto:info@autotrics.com" style="font-weight: 400; font-size: 12px; font-style: normal; text-decoration: none;">
                                info@autotrics.com
                            </a>
                        </td>
                    </tr>
                            ...
                            <table width="170" cellpadding="0" cellspacing="0" align="center" border="0"> 
                                <tr>
                                    <td width="170" height="46" bgcolor="#10a7e8" align="center" valign="middle" style="font-size: 16px; color: #ffffff; line-height:18px; -webkit-border-radius: 50px; -moz-border-radius: 50px; border-radius: 50px; font-weight:bold;" mc:label="the_btnText" mc:edit="the_btnText">
                                        <a href="http://localhost:9001/password-recovery?email=${recipient}&salt=${salt}" target="_blank" alias="" style="text-decoration: none; color: #ffffff;">Reset Password <span style="font-size:23px;">&rsaquo;</span></a>
                                    </td>
                                </tr>
                            </table>
                            <!-- End Button --> 
    ...
    reminderHTML: (reminder) => {
        ...
        const futureTime = moment().add(
            parseInt(reminder.interval_in_minutes),
            "minutes"
        );
        const formattedFutureTime = futureTime.format(
                ...
                <table style="width: 500px; margin-left: auto; margin-right: auto;">
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center; padding-top: 30px; letter-spacing: 1px;">
                            ...
                            <p style="font-weight: 400; font-size: 12px; font-style: normal; padding-top: 30px; line-height: 18px;">
                                Hello <b>${reminder.first_name}</b>!!!<br><br> 
                                This is a friendly reminder from AUTOTRICS that you have a <b><i>${reminder.reminder}</i></b> coming up. We recommend ensuring that this service is carried out promptly to keep your vehicle away from potential issues.<br><br><br>
                                Next reminder on : <i><b>${formattedFutureTime}</b></i>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="text-align: center; padding-top: 40px;">
                            ...
                            <table width="170" cellpadding="0" cellspacing="0" align="center" border="0"> 
                                <tr>
                                    <td width="170" height="46" bgcolor="#10a7e8" align="center" valign="middle" style="font-size: 16px; color: #ffffff; line-height:18px; -webkit-border-radius: 50px; -moz-border-radius: 50px; border-radius: 50px; font-weight:bold;" mc:label="the_btnText" mc:edit="the_btnText">
                                        <a href="http://localhost:9001/sign-in" target="_blank" alias="" style="text-decoration: none; color: #ffffff;">Go to My Dashboard <span style="font-size:23px;">&rsaquo;</span></a>
                                    </td>
                                </tr>
                            </table>
                            <!-- End Button --> 
